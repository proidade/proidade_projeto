<?php
  ...
  if (isset($_POST['logar'])){//se o botão estiver pressionado
    ...
    $sql = "INSERT INTO supplier VALUES (NULL, '$name', '$description');";
        ...
        <div class="box-parent-login">
          <div class="well bg-white box-login">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
              <fieldset >
                    <label ><b> INSIRA OS DADOS DO FORNECEDOR: <b></label>
                    ...
                    <button type="submit" value="Entrar" class="btn btn-primary btn-lg btn-block" name="logar">Concluir cadastro</button> <br><br>
