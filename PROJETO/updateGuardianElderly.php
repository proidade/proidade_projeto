<?php
    ...
    $identificadorPeopleGuardian = $_GET['idGuardianPeople'];
    $identificadorPeopleElderly   = $_GET['idIdosoPeople'];

    $sql = "SELECT * FROM people WHERE id = '$identificadorPeopleGuardian'";
    $resultado = mysqli_query($connectionMysqlProage, $sql);

    $sqlAddress = "SELECT * FROM address WHERE people_id = '$identificadorPeopleGuardian'";
    $resultadoAddress = mysqli_query($connectionMysqlProage, $sqlAddress);

    $sqlContact = "SELECT * FROM contact WHERE people_id = '$identificadorPeopleGuardian'";
                ...
                <div class='container p-5'>
                    <div class='card mx-3 mt-n5 shadow-lg' style='border-radius:0px; border:none'>
                        <div class='card-body p-5'>
                            <h4 class='card-title mb-3 text-dark text-uppercase' style='font-weight:700'>Atualizar dados do guardião - ".$name."</h4>
                            <form action='updateGuardianElderlyII.php?idIdosoPeople=".$identificadorPeopleElderly."' method='POST' >
                                <div class='row'>
                                    <div class='col'>
                                        <div class='form-floating mb-3'>
                                            <input type='hidden' name='idPeopleGuardian' class='form-control'  value='". $identificadorPeopleGuardian . "' >
                                            <input type='text' class='form-control'  value='". $identificadorPeopleGuardian . "' disabled >
                                    ...
                                    <a href='listarIdoso.php' style='color: #000000;'>Voltar</a><br><br>
