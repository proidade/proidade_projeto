...
<body>
	...
	<?php $confirmacao = $_GET['confirmacao']; if($confirmacao!=0){ echo '<script> confirm("Alterado com sucesso!")</script>';}?>
			...
			<?php
				while ($registro = mysqli_fetch_array($resultado)) {
					...
					echo "<tr>
							  ...
							  <td><a href='editarDevices.php?id=" . $registro['id']   .  " &part_number = ". $registro['part_number'] . "'>Editar</td>
                <td><a href='excluirDispositivos.php?id=" . $registro['id']  . "'>Excluir</t>
